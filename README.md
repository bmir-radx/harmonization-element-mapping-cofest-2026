...
The CSV dictionaries follow the [RADx Data Dictionary Specification](https://github.com/bmir-radx/radx-data-dictionary-specification/blob/main/radx-data-dictionary-specification.md) and include key information for the data element mappings:
